...
import { useResubmitPlan, useResubmitPlanToDtoe } from "@/packages/api/base/codegen";

import { Button } from "#/components/ui/button";

import { canResubmit, canResubmitToDtoe, showResubmitPanel } from "../lib/permissions";

export function ResubmitPanel({ detail }: { detail: PlanDetail }) {
  ...
  const resubmit = useResubmitPlan({ mutation: { onSuccess: () => void invalidate() } });
  const resubmitToDtoe = useResubmitPlanToDtoe({ mutation: { onSuccess: () => void invalidate() } });
