...
- [ ] 3.17 [frontend] Реализовать кнопку «Открыть» в строке таблицы; довести тест 3.16 до green.
- [ ] 3.18 [frontend] Падающий component-тест: фильтр «Только непрочитанные» скрывает/показывает прочитанные записи без запроса на сервер (клиентская фильтрация уже загруженного списка).
- [ ] 3.19 [frontend] Реализовать переключатель «Только непрочитанные»; довести тест 3.18 до green.
- [ ] 3.20 [frontend] Падающий component-тест: кнопка «Отметить все прочитанными» на странице `/notifications` снимает выделение со всех строк и обнуляет бейдж колокольчика (общий query key).
- [ ] 3.21 [frontend] Реализовать кнопку «Отметить все прочитанными» на странице (переиспользовать логику из 3.11); довести тест 3.20 до green.
